...
public final class ActivityResultBinding implements ViewBinding {
  ...
  private ActivityResultBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnClose,
      @NonNull MaterialButton btnPlayAgain, @NonNull TextView tvBest, @NonNull TextView tvStats,
  ...
  public static ActivityResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResultBinding((ScrollView) rootView, btnClose, btnPlayAgain, tvBest,
          tvStats, tvTitle);
    }
